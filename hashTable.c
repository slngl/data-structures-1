...
int main(int argc, char** argv) {
    ...
    insert_hash_table(htable,"eskisehir");
    insert_hash_table(htable,"istanbul");
    insert_hash_table(htable,"izmit");
    insert_hash_table(htable,"antalya");
    insert_hash_table(htable,"aydin");
    insert_hash_table(htable,"canakkale");
    insert_hash_table(htable,"sakarya");
       
    print_hash_table(htable);
    delete_hash_table(htable,"izmit");
    print_hash_table(htable);
